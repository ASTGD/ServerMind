...
- [x] **RESEARCHED — Claude "advisor tool"** → decided AGAINST the native tool for now
      ...
      "up" step). Shipped the broader **AI Model Ladder** instead (up/default/down model
      routing) — captures the value, provider-agnostic, and also saves cost on easy work.
