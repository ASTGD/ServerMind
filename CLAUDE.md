...
### Intelligence
- [ ] **RESEARCH + IMPLEMENT — Claude "advisor tool"** → https://platform.claude.com/docs/en/agents-and-tools/tool-use/advisor-tool
      Must research this Claude tool-use capability and decide how to apply it to Ally
      (e.g. sharpening Ally's plans/recommendations/mission decisions). Read the docs
      first, prototype, then wire into `ai_service`/the mission engine. **Not built yet —
      placeholder to implement later** (per PM, 2026-07-05).
...
- [ ] Periodic fleet-health email digest (reuse alert/notification plumbing)
