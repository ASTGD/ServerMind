    ...
    <div className={`flex flex-col rounded-lg border p-4 transition-all hover:shadow-sm ${cardClass}`}>
      ...
      <div className="mt-auto flex items-center justify-end gap-2 pt-3">
        <button
          ...
          className="flex items-center gap-1.5 rounded-md border border-border bg-background/60 px-2.5 py-1.5 text-xs font-medium text-foreground transition-colors hover:border-primary/50 hover:bg-primary/5 hover:text-primary"
        >
