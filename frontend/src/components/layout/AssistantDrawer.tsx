  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="Ally"
        aria-hidden={!open}
        className={`fixed left-3 right-3 top-[4.5rem] bottom-4 z-50 flex origin-bottom-left flex-col overflow-hidden rounded-2xl border border-border bg-card shadow-2xl transition-all duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] md:left-[15.75rem] md:right-5 ${
